...
class Danfe extends Common
{
    ...
    public function monta(
        ...
        if ($this->exibirValorTributos) {
            ...
            if ($vTotTrib != '' && !$flagVTT && $vTotTrib != 0) {
    ...
    protected function header($x = 0, $y = 0, $pag = '1', $totPag = '1')
    {
        ...
        if ($tpAmb != 1) {
            ...
            $aFont = ['font'=>$this->fontePadrao, 'size'=>48, 'style'=>''];
            $this->pdf->textBox($x, $y, $w, $h, $texto, $aFont, 'C', 'C', 0, '');
            $aFont = ['font'=>$this->fontePadrao, 'size'=>30, 'style'=>''];
    ...
    protected function itens($x, $y, &$nInicio, $hmax, $pag = 0, $totpag = 0, $hCabecItens = 7)
    {
        ...
        foreach ($this->det as $d) {
            if ($i >= $nInicio) {
                ...
                $y_linha=$y+$h;
                // linha entre itens
                $this->pdf->dashedHLine($oldX, $y_linha, $w, 0.1, 200);
                //corrige o x
                $x=$oldX;
                //codigo do produto
    ...
    protected function canhoto($x, $y)
    {
        ...
        if ($this->orientacao == 'P') {
            ...
            $x = $oldX;
            $y += 9;
            $this->pdf->dashedHLine($x, $y, $this->wPrint, 0.1, 120);
            $y += 2;
            return $y;
        } else {
            $x--;
